package com.example.calculadoraoperacionesbasica;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_numero_uno = findViewById(R.id.V2);
        edit_numero_dos = findViewById(R.id.V1);
        btn_sumar = findViewById(R.id.btsumar);
        ...
        btn_dividir = findViewById(R.id.btdividir);
        ...
        btn_multiplicar = findViewById(R.id.btmultiplicar);
        ...
        btn_restar = findViewById(R.id.btrestar);
